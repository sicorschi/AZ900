> [!TIP]
> ### ⚠️ When building or deploying a cloud application, two of the biggest considerations are uptime (or availability) and the ability to handle demand (or scale).

![alt text](<Captura de pantalla 2026-06-13 a las 2.45.03.png>)
...
![alt text](<Captura de pantalla 2026-06-13 a las 2.46.15.png>)
...
# :white_check_mark: Vertical scaling
