> [!IMPORTANT]
> #### ⚠️ With Azure, you pay for IT resources as you use them instead of purchasing and maintaining your own infrastructure. Whether it's compute, storage, or networking, you rent what you need and release it when you're done. This consumption-based approach means your costs scale with your actual usage.
...
![alt text](<Captura de pantalla 2026-06-14 a las 4.03.53.png>)
...
![alt text](<Captura de pantalla 2026-06-14 a las 4.04.50.png>)
...
## :white_check_mark: Network traffic
...
## :white_check_mark: Subscription type
...
## :white_check_mark: Azure Marketplace
