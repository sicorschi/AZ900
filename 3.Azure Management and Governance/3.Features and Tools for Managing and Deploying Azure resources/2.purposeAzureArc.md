> [!IMPORTANT]
> #### ⚠️ Managing hybrid and multicloud environments can rapidly get complicated. Azure provides a host of tools to provision, configure, and monitor Azure resources. What about the on-premises resources in a hybrid configuration or the cloud resources in a multicloud configuration? Azure Arc works with Azure Resource Manager to extend your Azure compliance and monitoring to hybrid and multicloud configurations. Azure Arc simplifies governance and management by delivering a consistent multicloud and on-premises management platform.

![alt text](<Captura de pantalla 2026-06-14 a las 4.39.10.png>)
...
## :white_check_mark: Practical scenario
...
## :white_check_mark: What can Azure Arc do outside of Azure?
