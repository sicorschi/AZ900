> [!IMPORTANT]
> #### ⚠️ Virtual machines reduce costs compared to physical hardware, but they're still limited to a single operating system per VM. If you want to run multiple instances of an application on a single host machine, containers are an excellent choice.
...
## :white_check_mark: Azure Container Instances
...
## :white_check_mark: Azure Container Apps
...
## :white_check_mark: Azure Kubernetes Service

Azure Kubernetes Service (AKS) is a container orchestration service. An orchestration service manages the lifecycle of containers. When you're deploying a fleet of containers, AKS can make fleet management simpler and more efficient.

## :white_check_mark: Use containers in your solutions
