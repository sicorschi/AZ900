> [!IMPORTANT]
> #### ⚠️ Zero Trust is a security model that assumes the worst case scenario and protects resources with that expectation. Zero Trust assumes breach at the outset, and then verifies each request as though it originated from an uncontrolled network.
...
![alt text](<Captura de pantalla 2026-06-14 a las 2.52.51.png>)

## :white_check_mark: Adjusting to Zero Trust
...
## :white_check_mark: Example in practice
...
![alt text](<Captura de pantalla 2026-06-14 a las 2.54.12.png>)
