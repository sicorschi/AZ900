> [!IMPORTANT]
> #### ⚠️ When you have multiple IT and engineering teams, how can you control what access they have to the resources in your cloud environment? The principle of least privilege says you should only grant access up to the level needed to complete a task. If you only need read access to a storage blob, then you should only be granted read access to that storage blob — not write access, and not access to other blobs. It's a good security practice to follow.
...
## :white_check_mark: How is role-based access control applied to resources?
...
![alt text](<Captura de pantalla 2026-06-14 a las 2.48.45.png>)
...
## :white_check_mark: How is Azure RBAC enforced?
