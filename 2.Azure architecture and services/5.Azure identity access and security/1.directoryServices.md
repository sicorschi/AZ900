> [!IMPORTANT]
> #### ⚠️ Microsoft Entra ID is Microsoft's cloud-based identity and access management service. It lets you sign in and access both Microsoft cloud applications and cloud applications that you develop.
...
![alt text](<Captura de pantalla 2026-06-14 a las 2.27.46.png>)

## :white_check_mark: Can I connect my on-premises AD with Microsoft Entra ID?
...
## :white_check_mark: What is Microsoft Entra Domain Services?
...
## :white_check_mark: How does Microsoft Entra Domain Services work?
...
## :white_check_mark: Is information synchronized?
...
![alt text](<Captura de pantalla 2026-06-14 a las 2.31.04.png>)
