> [!IMPORTANT]
> #### ⚠️ An external identity is a person, device, or service that exists outside your tenant. Microsoft Entra External ID includes the capabilities used to securely interact with users beyond your tenant boundary.

## :white_check_mark: Why external identities matter
...
![alt text](<Captura de pantalla 2026-06-14 a las 2.41.49.png>)

## :white_check_mark: External ID capabilities
...
![alt text](<Captura de pantalla 2026-06-14 a las 2.43.01.png>)

Depending on your collaboration goals and the resources being shared, you can combine these capabilities.

## :white_check_mark: Manage guest access over time
