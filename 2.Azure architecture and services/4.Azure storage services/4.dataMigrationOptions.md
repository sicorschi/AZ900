> [!IMPORTANT]
> #### ⚠️ Now that you understand the different storage options within Azure, it's important to also understand how to get your data into Azure. Azure supports both real-time migration of infrastructure, applications, and data using Azure Migrate as well as asynchronous migration of data using Azure Data Box.

![alt text](<Captura de pantalla 2026-06-13 a las 5.52.05.png>)

## :white_check_mark: Azure Migrate
...
## :white_check_mark: Integrated tools
...
## :white_check_mark: Azure Data Box
